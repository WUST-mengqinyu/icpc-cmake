...
namespace {
  std::unique_ptr<clang::CompilerInvocation> buildCompilerInvocation(clang::ArrayRef<const char *> args) {
    clang::IntrusiveRefCntPtr<clang::DiagnosticsEngine> diags(
            clang::CompilerInstance::createDiagnostics(new clang::DiagnosticOptions, new clang::IgnoringDiagConsumer, true));
